...
SELECT apellidos FROM personas WHERE localidad = 'LORCA' OR localidad = 'MURCIA';
...
SELECT apellidos, CHARACTER_LENGTH (apellidos) FROM personas;
...
SELECT * FROM personas WHERE salario > 1500 AND (cod_hospital = 1 OR cod_hospital = 2);
